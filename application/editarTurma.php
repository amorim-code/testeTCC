...
<html lang="pt-br">
    ...
    <?php
        ...
        if (isset($_GET['ID'])):
            ...
            $query = "SELECT t.cod_turma, t.nome_turma, t.semestre_turma, t.ano_turma, c.nome_curso FROM turma AS t INNER JOIN curso AS c ON t.cod_curso = c.cod_curso WHERE cod_turma = {$idTurma}";
        ...
        <div>
            <form class="editarTurma" method="POST" action="editTurma.php">
                ...
                <input type="text" name="txtSemestreTurma" id="txtSemestreTurma" value="<?php echo $turma['semestre_turma'] ?>"><br>                
