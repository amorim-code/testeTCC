...
--
-- Host: 127.0.0.1
-- Generation Time: 05-Nov-2020 às 02:19
...
(4, 'TÉCNICAS DE PROGRAMAÇÃO PARA I', '', 4),
(5, 'QUÍMICA', '', 4);
...
(1, 1, '3AIIIII', '2 semestre', '2020'),
(2, 2, '3AE', '2 semestre', '2020'),
(3, 3, '1AL', '1 semestre', '2019'),
(4, 1, '2ª SÉRIE', '2º SEM', '2019'),
(5, 1, '2ª SÉRIE', '2º SEM', '2019'),
(6, 3, '3BL', '2 Semestre', '2020'),
(7, NULL, '3AY', '2 Semestre', '2020');
...
('170410', 'JOAO PEDRO CHEQUI PORTELA', '', '', 'Aluno'),
...
--
ALTER TABLE `atividade`
  MODIFY `codAtividade` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `turma`
  MODIFY `cod_turma` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
